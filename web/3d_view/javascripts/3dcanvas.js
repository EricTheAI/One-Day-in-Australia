...
function getLive() {
    ...
    var d3_datat= "https://raw.githubusercontent.com/CrazyEric1994/One-Day-in-Melbourne/master/web/3d_data.txt?token=AD0CtF-69xUoyqhAfYKmYfVITFroMJGjks5ZGQegwA%3D%3D";

    d3.json(d3_datat, function(err, data) {
        if (err) throw err;
        index++;
        if (data === undefined) {
            alert("Error");
